 ...
 * parent expects a float value and calls {@link HashemBooleanLiteralNode#executeBoolean}. In the generic case,
 * the primitive value is automatically boxed by Java.
 */
@NodeInfo(shortName = "const")
public final class HashemBooleanLiteralNode extends HashemExpressionNode {

    private final boolean value;

    public HashemBooleanLiteralNode(boolean value) {
        this.value = value;
    }

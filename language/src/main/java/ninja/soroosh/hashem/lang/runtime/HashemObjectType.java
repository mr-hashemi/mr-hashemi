...
public final class HashemObjectType extends ObjectType {

    protected static final int CACHE_LIMIT = 3;
    public static final ObjectType SINGLETON = new HashemObjectType();

    private HashemObjectType() {
    }

    @Override
    public Class<?> dispatch() {
        return HashemObjectType.class;
    }

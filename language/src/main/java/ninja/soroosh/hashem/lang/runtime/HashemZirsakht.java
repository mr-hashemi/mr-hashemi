...
public final class HashemZirsakht implements TruffleObject {

    /**
     * The canonical value to represent {@code null} in Hashem.
     */
    public static final HashemZirsakht SINGLETON = new HashemZirsakht();

    /**
     * Disallow instantiation from outside to ensure that the {@link #SINGLETON} is the only
     * instance.
     */
    private HashemZirsakht() {
    }
    ...
    /**
     * {@link HashemZirsakht} values are interpreted as null values by other languages.
     */
    @ExportMessage
    boolean isNull() {
        return false;

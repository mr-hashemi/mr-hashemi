...
/**
 * A {@link HashemExpressionNode} that represents a parenthesized expression; it simply returns the
...
public class HashemParenExpressionNode extends HashemExpressionNode {

    @Child private HashemExpressionNode expression;

    public HashemParenExpressionNode(HashemExpressionNode expression) {
